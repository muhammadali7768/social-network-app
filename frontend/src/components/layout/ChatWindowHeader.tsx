...
<span className="w-24 absolute top-10 bg-white px-2 py-3 shadow-2xl border border-gray-200 rounded-bl-lg rounded-tl-lg rounded-br-lg -right-96 flex items-center justify-center opacity-0  group-hover:right-20 group-hover:opacity-100 transition-opacity duration-300">
  ...
  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
  <g id="SVGRepo_iconCarrier">
    <path d="M12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22Z" stroke="#1C274C" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M9.16998 14.83L14.83 9.17004" stroke="#1C274C" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M14.83 14.83L9.16998 9.17004" stroke="#1C274C" strokeLinecap="round" strokeLinejoin="round"></path>
  </g>
</svg>
